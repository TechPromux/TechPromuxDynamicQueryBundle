...
class DayNumberOfMonthFieldFunctionType implements BaseFieldFunctionType
{
    ...
    {
        return 'DATE.DAY_NUMBER_OF_MONTH';
    }
    ...
    {
        return sprintf('DAYOFMONTH(%s)', $field_sql_name);
    }
