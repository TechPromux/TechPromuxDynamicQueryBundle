...
class DateOfFirstDayOfMonthFieldFunctionType implements BaseFieldFunctionType
{
    ...
    {
        return 'DATE.DATE_OF_FIRST_DAY_OF_MONTH';
    }
    ...
    {
        return 'DATE_OF_FIRST_DAY_OF_MONTH';
    }
    ...
    {
        return sprintf('DATE_FORMAT(%s,', $field_sql_name).'\'%Y-%m-01 00:00:00\')';
    }
